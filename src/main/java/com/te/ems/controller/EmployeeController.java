...
public record EmployeeController(
	...
	//public ResponseEntity<SucessResponse> getEmployee(@RequestParam(name = "employeeID") String employeeID){
		...
		return ResponseEntity.<SuccessResponse>ofNullable(SuccessResponse.builder()
				             ...
				             .data(Employee.builder().employeeID(employeeID))
				             .timestamp(LocalDateTime.now())
				             .build());
	}
	...
	public ResponseEntity<SuccessResponse> deleteEmployee(@RequestBody DeleteEmployeeDTO deleteEmployeeDTO){
		String result = employeeservice.deleteEmployee(deleteEmployeeDTO);
		return ResponseEntity.<SuccessResponse>ofNullable(SuccessResponse.builder()
